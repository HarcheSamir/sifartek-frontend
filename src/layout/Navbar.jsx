    ...
    return (
        <div className='fixed top-0 z-40 py-3 items-center bg-primary w-screen justify-between flex px-4 lg:px-20 text-[#666666]'>
            <img 
                ...
                alt='Logo' 
                src={'/assets/logo.svg'} 
                className='w-[100px] cursor-pointer duration-300 hover:scale-110' 
                onClick={() => navigate('/login')} 
            />
            <div className='md:flex text-sm hidden md:gap-4 xl:gap-20 max-w-[80%] items-center'>
            ...
            <div className='cursor-pointer text-xs hidden md:block whitespace-nowrap px-4 py-2 rounded text-white font-semibold hover:bg-secondaryHovered bg-secondary'>
                Book Now
            </div>
